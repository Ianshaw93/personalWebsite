...
const Contact = () => {
    return (
        ...
        <div className='w-full h-screen bg-[#CBD0D3] flex justify-center items-center p-4'>
            <form method='POST' action="https://getform.io/f/a699a1b2-f225-434e-b317-1fbbde8e006c" className='flex flex-col max-w-[600px] w-full'>
                ...
                <button className='text-[#393E41] border-2 hover:bg-[#40AAE8] hover:border-[#40AAE8] hover:text-white px-4 py-3 my-8 mx-auto flex items-center'>Let's Collaborate</button>
            </form>
        </div>
      )
}
